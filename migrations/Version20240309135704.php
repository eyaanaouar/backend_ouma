 ...
 */
final class Version20240309135704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE birmcherguatg2 DROP date, DROP rendement, DROP tauxdegradation, DROP emissionCO2, DROP consogaz, CHANGE id_birmcherquaTG1 id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON birmcherguatg2');
        $this->addSql('ALTER TABLE birmcherguatg2 ADD date INT NOT NULL, ADD rendement INT NOT NULL, ADD tauxdegradation INT NOT NULL, ADD emissionCO2 INT NOT NULL, ADD consogaz INT NOT NULL, CHANGE id id_birmcherquaTG1 INT AUTO_INCREMENT NOT NULL');
